...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-sm px-3 py-8 md:py-16 lg:py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-8 md:gap-20 md:grid-cols-2">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full  w-full rounded-2xl md:rounded-3xl object-center"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
        ...
        <div className="flex flex-col justify-between py-2 md:py-4">
          ...
          >
            ...
            <motion.p className="mt-4 md:mt-8 text-sm md:text-lg text-gray-500  line-clamp-6 md:line-clamp-none">
          ...
          <div className="flex gap-3 md:gap-4 pt-6 md:pt-12">
            <button
              onClick={handlePrev}
              className="group/button flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 transition-colors dark:bg-neutral-800"
            >
