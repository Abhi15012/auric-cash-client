...
export function TermsSidebar({ className, ...props }: TermsSidebarProps) {
  ...
  const navItems = [
    ...
    { id: "data-usage", label: "4. Data Usage and Privacy" },
    { id: "limitation", label: "5. Limitation of Liability" },
    { id: "termination", label: "6. Termination Clause" },
    { id: "subscription", label: "7. Subscription and Payment" },
    { id: "governing-law", label: "8. Governing Law" },
    { id: "compliance", label: "9. Compliance and Regulatory" },
